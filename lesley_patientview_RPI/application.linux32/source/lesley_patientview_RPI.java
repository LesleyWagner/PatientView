...
public class lesley_patientview_RPI extends PApplet {
 ...
 */
public int[] decodeData(byte[] dataPacket) {
 ...
 * updates data points
 */
public void updatePoints(int[] dataPoints) {
 ...
 */
public ArrayList<byte[]> encodeData(ArrayList<int[]> newData) {
  ArrayList<byte[]> encodedData = new ArrayList<byte[]>();
 ...
 */
public void sendSensorData(ArrayList<byte[]> newData) {
 ...
 */
public void logData(float red, float ir, float hr, float spo2, float temperature) {
  try {
 ...
 */
public ArrayList<int[]> updateTestPoints() {
  ArrayList<int[]> newData = new ArrayList<int[]>();
  ...
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "lesley_patientview_RPI" };
    if (passedArgs != null) {
