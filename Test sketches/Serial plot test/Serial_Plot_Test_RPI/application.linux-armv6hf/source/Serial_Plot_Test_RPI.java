...
public class Serial_Plot_Test_RPI extends PApplet {
...
public void testSetup() {
  ...
  float[] ecgTestData = PApplet.parseFloat(ecgFileContents[0].split(","));
...
public void logData(double ecg, double red, double ir) {
  try {
    date = new Date();
  ...
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "Serial_Plot_Test_RPI" };
    if (passedArgs != null) {
